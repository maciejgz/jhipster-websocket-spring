package pl.mg.springwebsocket.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipster_websocket_spring");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipster_websocket_spring");
        ...
        config.getMapConfigs().put("pl.mg.springwebsocket.domain.*", initializeDomainMapConfig(jHipsterProperties));
