package pl.mg.springwebsocket.repository;

import pl.mg.springwebsocket.JhipsterWebsocketSpringApp;
import pl.mg.springwebsocket.config.Constants;
import pl.mg.springwebsocket.config.audit.AuditEventConverter;
import pl.mg.springwebsocket.domain.PersistentAuditEvent;
...
import static pl.mg.springwebsocket.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
